...
def runExperiment(n,m):
    ...
    for x in list_strings:
        ...
        csvWriter.writerow([x,complexity_string[0],complexity_string[1],complexity_string[2]])
        print("Result :",[x,complexity_string[0],complexity_string[1],complexity_string[2]])
